...
class MatrixChainMultiplication(Scene):
    ...
    def construct(self):
        ...
        self.play(
            ...
            FadeIn(temp[2]),
            TransformFromCopy(text2[-1], temp[3]),
            TransformFromCopy(text3[0], temp[3]),
            FadeIn(temp[4]),
        ...
        text4 = (
            Text("30 x 60").scale(0.7).move_to(VGroup(text2, text3)).set_color(YELLOW)
        )
        ...
        self.play(
            Transform(
                brace2, Brace(VGroup(text1, text3), DOWN, buff=0.7).shift(RIGHT * 0.25)
            )
        )
        self.wait(2)
        ...
        self.play(
            ...
            FadeIn(temp[2]),
            TransformFromCopy(text1[-2:], temp[3:5]),
            TransformFromCopy(text4[0:2], temp[3:5]),
            FadeIn(temp[5]),
        ...
        self.play(
            FadeOut(brace2), FadeOut(text4), ShowCreation(text2), ShowCreation(text3)
        )
...
class MatrixMultiplication(Scene):
    ...
    def construct(self):
        ...
        self.play(
            Uncreate(a), Uncreate(b), self.camera.frame.animate.shift(DOWN * 1.36)
        )

        self.wait()

        matrix3 = (
            Matrix([["ag+bi+ck", "ah+bj+cl"], ["dg+ei+fk", "dh+ej+fl"]])
            .scale(1.3)
            .shift(DOWN * 4 + RIGHT * 1.17)
        )
        ...
        text_3 = (
            Text("2 x 2")
            .next_to(matrix3, DOWN)
            .shift(DOWN * 0.1)
            .scale(0.77)
            .set_color(BLUE)
        )
        self.play(
            TransformFromCopy(text_1[0], text_3[0]),
            TransformFromCopy(text_2[-1], text_3[2]),
            FadeIn(text_3[1]),
        ...
        final_rect = SurroundingRectangle(
            matrix3.get_entries()[0], color=RED, buff=0.1
        ).scale(1.07)
        ...
        row_rect = SurroundingRectangle(
            matrix1.get_rows()[0], color=YELLOW, buff=0.1
        ).scale(1.07)

        col_rect = SurroundingRectangle(
            matrix2.get_columns()[0], color=GREEN, buff=0.1
        ).scale(1.07)
        ...
        self.play(
            Transform(
                ...
                SurroundingRectangle(
                    matrix3.get_entries()[1], color=RED, buff=0.1
                ).scale(1.07),
            )
        )
        ...
        self.play(
            Transform(
                col_rect,
                SurroundingRectangle(matrix2.get_columns()[1], color=GREEN).scale(1.07),
            )
        )
        self.wait(1)
        ...
        self.play(
            Transform(
                final_rect,
                SurroundingRectangle(
                    matrix3.get_entries()[2], color=RED, buff=0.1
                ).scale(1.07),
            )
        )
        ...
        self.play(
            Transform(
                col_rect,
                SurroundingRectangle(matrix2.get_columns()[0], color=GREEN).scale(1.07),
            ),
            Transform(
                row_rect,
                SurroundingRectangle(matrix1.get_rows()[1], color=YELLOW).scale(1.07),
            ),
        )
        self.wait(1)
        ...
        self.play(
            Transform(
                final_rect,
                SurroundingRectangle(
                    matrix3.get_entries()[3], color=RED, buff=0.1
                ).scale(1.07),
            )
        )
        ...
        text = (
            Text("3")
            .next_to(matrix2, RIGHT, buff=0.8)
            .scale(1.7)
            .shift(RIGHT * 2.88 + DOWN)
        )
        ...
        dimention = (
            Text("p x r")
            .next_to(text1, DOWN, buff=0.7)
            .scale(1.4)
            .shift(DOWN * 0.7 + LEFT * 1.8)
        )
        ...
        self.play(
            TransformFromCopy(text1[2], final[2]), TransformFromCopy(text2[0], final[2])
        )
        ...
        rect_text = (
            Text("Number of Operations").scale(0.9).next_to(rect, RIGHT, buff=0.5)
        )
        self.play(Write(rect_text))
...
class MatrixChainMultiplication(Scene):
    def construct(self):
        ...
        # Dimension texts
        text1 = (
            Text("2 x 3").next_to(a[0], DOWN, buff=0.36).scale(0.7).set_color(YELLOW)
        )
        text2 = (
            Text("3 x 4").next_to(a[1], DOWN, buff=0.36).scale(0.7).set_color(YELLOW)
        )
        text3 = (
            Text("4 x 5").next_to(a[2], DOWN, buff=0.36).scale(0.7).set_color(YELLOW)
        )
        text4 = (
            Text("5 x 6").next_to(a[3], DOWN, buff=0.36).scale(0.7).set_color(YELLOW)
        )
        ...
        # Dimension array
        dimension_array = (
            Text("[2, 3, 4, 5, 6]", font_size=62)
            .next_to(text3, DOWN, buff=0.86)
            .shift(LEFT * 1.12 + DOWN)
        )
        ...
        self.play(
            self.camera.frame.animate.scale(0.94)
            .shift(DOWN * 0.66)
            .scale(1.15)
            .shift(DOWN * 0.68)
        )
        ...
        calculation_box = Rectangle(
            width=12, height=0.9, fill_opacity=1, color=YELLOW, fill_color=BLACK
        )
        ...
        for i in range(n):
            ...
            if row_highlight is None:
                ...
                row_highlight = SurroundingRectangle(
                    row_label_obj, buff=0.05, color=BLUE, stroke_width=2
                )
                row_highlight.scale(1.15)
                col_highlight = SurroundingRectangle(
                    col_label_obj, buff=0.05, color=BLUE, stroke_width=2
                )
                col_highlight.scale(1.15)
                row_highlight2 = SurroundingRectangle(
                    row_label_obj2, buff=0.05, color=BLUE, stroke_width=2
                )
                row_highlight2.scale(1.15)
                col_highlight2 = SurroundingRectangle(
                    col_label_obj2, buff=0.05, color=BLUE, stroke_width=2
                )
                ...
                new_row_highlight = SurroundingRectangle(
                    row_label_obj, buff=0.05, color=BLUE, stroke_width=2
                )
                new_row_highlight.scale(1.15)
                new_col_highlight = SurroundingRectangle(
                    col_label_obj, buff=0.05, color=BLUE, stroke_width=2
                )
                new_col_highlight.scale(1.15)
                new_row_highlight2 = SurroundingRectangle(
                    row_label_obj2, buff=0.05, color=BLUE, stroke_width=2
                )
                new_row_highlight2.scale(1.15)
                new_col_highlight2 = SurroundingRectangle(
                    col_label_obj2, buff=0.05, color=BLUE, stroke_width=2
                )
            ...
            diag_calc_text = Text(
                f"Cost[{i},{i}] = 0 (single matrix)", font_size=24
            ...
            self.play(FadeOut(cell_highlight), FadeOut(cell_highlight2))
        ...
        for l in range(1, n):
            ...
            chain_calc_text = Text(
                f"Calculating for chain length {l+1}", font_size=24
            ).move_to(calculation_box.get_center())
            ...
            if l == 2:  # For 3-chain (like ABC), add a special explanation
                explain_text = Text(
                    f"For 3 matrices (like ABC), we need to check all possible groupings:",
                    font_size=20,
                ).move_to(calculation_box.get_center())
                ...
                options_text = Text(f"(A(BC)) vs ((AB)C)", font_size=20).move_to(
                    calculation_box.get_center()
                )
                ...
                choose_text = Text(
                    f"We'll choose the grouping with minimum number of operations",
                    font_size=20,
                ).move_to(calculation_box.get_center())
            ...
            for i in range(n - l):
                ...
                calc_desc_text = Text(
                    f"Calculating optimal cost for {matrix_range}", font_size=22
                ).move_to(calculation_box.get_center())
                ...
                if l > 1:  # Only for chain length > 2 (3 or more matrices)
                    grouping_text = Text(
                        f"Possible ways to group {matrix_range}:", font_size=22
                    ).move_to(calculation_box.get_center())
                    ...
                    groupings_display = Text(
                        ", ".join(grouping_examples), font_size=20
                    ).move_to(calculation_box.get_center())
                    ...
                    testing_text = Text(
                        f"Testing each split point...", font_size=22
                    ).move_to(calculation_box.get_center())
                ...
                for k in range(i, j):
                    ...
                    split_desc = Text(
                        f"Testing split: ({left_part})({right_part})", font_size=20
                    ).move_to(calculation_box.get_center())
                    ...
                    if cost < min_cost:
                        ...
                        min_text = Text(
                            f"New minimum cost: {min_cost} at split: ({left_part})({right_part})",
                            font_size=20,
                        ).move_to(calculation_box.get_center())
                    ...
                    self.play(FadeOut(left_cell), FadeOut(right_cell))
                ...
                cost_text = Text(str(min_cost), font_size=24, color=WHITE).move_to(
                    cell_pos
                )
                split_text = Text(str(min_k), font_size=24, color=WHITE).move_to(
                    order_cell_pos
                )
                ...
                final_text = Text(
                    f"Optimal for {matrix_range}: ({left_part})({right_part}) with cost {min_cost}",
                    font_size=20,
                ).move_to(calculation_box.get_center())
        ...
        final_result = Text(
            f"Optimal multiplication cost: {optimal_cost}", font_size=32
        ).move_to(calculation_box.get_center())
        ...
        step_text = Text("Tracing optimal parenthesization...", font_size=24).move_to(
            calculation_box.get_center()
        )
        ...
        def trace_parenthesization(i, j, depth=0):
            ...
            if i == j:
                step = Text(
                    f"Matrix {labels[i]} (single matrix)", font_size=24
                ).move_to(calculation_box.get_center())
            ...
            step = Text(
                f"For {matrix_range}, split at k={k}: ({left_part})({right_part})",
                font_size=20,
            ).move_to(calculation_box.get_center())
            ...
            # Process left part
            left_step = Text(f"Process left part: {left_part}", font_size=24).move_to(
                calculation_box.get_center()
            )
            ...
            # Process right part
            right_step = Text(
                f"Process right part: {right_part}", font_size=24
            ).move_to(calculation_box.get_center())
            ...
            combine_step = Text(f"Combine: {result}", font_size=24).move_to(
                calculation_box.get_center()
            )
        ...
        final_parens = Text(
            f"Optimal parenthesization: {optimal_parens}", font_size=24
        ).move_to(calculation_box.get_center())
    ...
    def create_table(self, labels, title_text, position_shift):
        ...
        for i in range(rows):
            for j in range(cols):
                ...
                cell = Rectangle(
                    width=cell_width, height=cell_height, stroke_width=1, color=WHITE
        ...
        for i in range(rows):
            ...
            label = Text(labels[i], font_size=24).move_to(
                [position_shift[0] - cols / 2 * cell_width - 0.4, pos_y, 0]
            )
        ...
        for j in range(cols):
            ...
            label = Text(labels[j], font_size=24).move_to(
                [pos_x, position_shift[1] + rows / 2 * cell_height + 0.4, 0]
            )
